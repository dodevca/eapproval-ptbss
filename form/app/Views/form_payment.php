...
<html>
    <head>
        ...
        <title>Formulir Permintaan Pembayaran</title>
    ...
    <body>
        ...
        <main>
            ...
            <div class="container-fluid bg-primary text-center py-4">
                <h1 class="h3 mb-0 text-center text-white">Permintaan Pembayaran</h1>
            </div>
            <div class="container py-4">
                <?= form_open_multipart(base_url('/submit')); ?>
                    <?= csrf_field(); ?>
                    <input type="type" class="form-control d-none" id="type" name="type" value="permintaan pembayaran" required />
                        ...
                        <div class="col-lg-9">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="name" class="form-control" id="recipientName" name="recipientName" placeholder="Masukkan nama penerima" required />
                                    <div class="invalid-feedback">
                                        Nama tidak boleh mengandung angka
                                    </div>
                                </div>
